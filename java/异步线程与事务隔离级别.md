...
难道是代理类的问题？其实跟代理类有关系，但主要原因是事务在Spring里面存在ThreadLocal里，异步线程无法共享。在同一个class中为什么又可以共享了呢？

其实Spring保存线程事务用的是`NamedThreadLocal`

![image-20241020001156470](https://cdn.fengxianhub.top/resources-master/image-20241020001156470.png)
