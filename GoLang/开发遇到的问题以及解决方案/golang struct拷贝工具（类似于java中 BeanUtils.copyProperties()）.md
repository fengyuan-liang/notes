...
在开发中我们经常需要拷贝结构体的属性，例如前端传参时会比db表中对应接口体多一个属性

我们用`gin`开发时，一般都会用一个结构体来保存前端传来的json数据
...
但是传给其他服务时（例如保存到db中），我们又希望只要db中对应的结构体，这时候我们只需要
...
![image-20230130225029278](https://cdn.fengxianhub.top/resources-master/image-20230130225029278.png)
